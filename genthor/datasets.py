...
class GenerativeDataset64Objectome_rotonly(GenerativeDatasetBase):

    model_categories = dict_inverse(model_info.MODEL_CATEGORIES_OBJETOME_BASIC_LEVEL) 
    models = ['weimaraner',
        ...
        'pear_obj_2', #wasn't rosch-vetted
        'household_aid_29',
        '22_acoustic_guitar',
        'MB30850',
        'MB30798',
    ...
    templates = [
                 {'n_ex_per_model': 100,
                  'name': 'Objectome64_rotonly', 
                  'template': {'bgname': 'graybg.jpg',
                     'bgscale': 1.,
                     'bgpsi': 0,
                     'bgphi': uniform(-180.0, 180.),
                     's': 1,
                     ...
                     'rxz': uniform(-180., 180.),
                     # 'internal_canonical':True,
                     'light_spec': [{'name': 'alight1', 'type': 'AmbientLight', 'color':(1.,1.,1.,1.)}],
                     'use_envmap':False,
                     'texture':None,
                     'texture_mode':None,
                     }
...
class GenerativeDataset64Objectome_2ndHalf(GenerativeDatasetBase):

    model_categories = dict_inverse(model_info.MODEL_CATEGORIES_OBJETOME_BASIC_LEVEL) 
    models = ['lo_poly_animal_ANT_RED',
         'calc01',
         'MB27585',
         'Doctor_pose02',
         'womens_halterneck_06',
...
class GenerativeDataset32Objectome_final(GenerativeDatasetBase):
